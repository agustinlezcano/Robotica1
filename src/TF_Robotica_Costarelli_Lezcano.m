...
switch x
    ...
    case 2
        ...
        [q1,f,q_fuera]=cinv(q_ini,dh,T_fuera,R);            %q1 se puede omitir
        fprintf('El conjunto de soluciones articulares calculadas es:\n')
        q_fuera
    ...
    case 3
        ...
        fprintf('Presione una tecla para continuar (tiene que esperar 10 000 interaciones) \n')
        pause();
    ...
    case 4
        ...
        T1f=transl(P(3,:)');
        T1f=T1f*trotx(-pi/2)*troty(pi/2)*trotz(pi);
        ...
        T01=T0*transl(0,0,-0.6);
        T02=T01*transl(0,-0.3,0);
        ...
        T13=T12*transl(-0.15,0,0); %maniobra de seguridad
        ...
        fprintf('Para la trayectoria realizada con Jtraj y Ctraj\n\n')
        fprintf('Presione una tecla para continuar\n');
        pause();
        close all;
